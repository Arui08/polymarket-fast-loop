...
- **Google Workspace路由**: 用户提到“谷歌日历 / Google Calendar / 加日程 / 看今天日程 / 发Gmail / 查邮件 / Google Drive / Google Sheet / Google Docs”时，默认优先走 `skills/google-workspace-router/` 或本地 `gws` 能力，避免被普通“提醒/文档”意图误判。
